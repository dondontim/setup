...
if [ "$color_prompt" = yes ]; then
  ...
  # NOTE(tim): Above line is original one
  # 🤠🇵🇱✨🔥🔒 ⌘ | 提摩太 - Tí mó tài - Tymoetusz
...
#
  ...
  # LINUX(tim): replace above 2 lines with below ones on linux
  ############################################################
...
# LINUX(tim): uncomment block below on linux
############################################################
