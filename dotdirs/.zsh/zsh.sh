...
# TODO(tim): create file checking for updates from my privete github repo i will create
...
# Specify compinit dir
# https://zsh.sourceforge.io/Doc/Release/Completion-System.html#Use-of-compinit
# TODO(tim): manage zcompdump. Check below - ZSH_COMPDUMP that creates that file
# This is commented because of few lines below block
# compinit -d $ZSH_CACHE_DIR/completions/.zcompdump 
...
# source all test dir files
source_whole_dir $ZSH/test
